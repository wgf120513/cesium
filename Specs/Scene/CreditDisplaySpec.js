defineSuite([
    ...
    var container;
    var textContainerClass = 'cesium-credit-textContainer';
    var creditDisplay;
    var defaultCredit;
    ...
    it('credit display displays text credit', function() {
        ...
        expect(child1.className).toEqual(textContainerClass);
        expect(child0.childNodes.length).toEqual(1);
        expect(child0.childNodes[0]).toBe(CreditDisplay.cesiumCredit.element);
